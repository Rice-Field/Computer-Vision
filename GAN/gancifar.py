...
# This file begins the training process from the beginning
# Epochs set to 1
...
# Labels and testing data will not be used
...
def generator(z, reuse=False):
    with tf.variable_scope('Generator', reuse=reuse):
        # Input generator uses fully connected network for noise
        ...
        # 3 Series of deconvolutions with normalization and activations
        # Image dimensions double every convo
...
def discriminator(img, reuse=False):
    with tf.variable_scope('Discriminator', reuse=reuse):
        ...
        # 3 Series of convolutions with normalization and activations
        # Image dimensions halves every convolution
        ...
        # Single neuron for predicting if image is real or fake
